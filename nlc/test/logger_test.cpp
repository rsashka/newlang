...
TEST(Logger, HexToByte) {
    ...
    EXPECT_THROW(HexToByte('w'), std::runtime_error);
    EXPECT_THROW(HexToByte('+'), std::runtime_error);
    EXPECT_THROW(HexToByte('S'), std::runtime_error);
}
...
//    EXPECT_THROW(HexToBin(nullptr, buffer.data(), buffer.size()), std::runtime_error);
//    EXPECT_THROW(HexToBin(nullptr, nullptr, buffer.size()), std::runtime_error);
//    EXPECT_THROW(HexToBin("", nullptr, buffer.size()), std::runtime_error);
