...
Тип переменных используется для проверки их совместимости, когда уже существующему объекту присваивается другое значение,
при проверке типа возвращаемоего результата в функции (если он был указан) 
или для указания способа размещения объектов в памяти компьютера для [нативных типов](/ru/docs/types/native/).
