...
Создать глобальную (статическую) переменную в текущих пространствах имен без их перечисления, указав перед имененм переменную препроцессора **@::**.
...
где **root** и **dir** это каталоги в файловой системе относительно текущего модуля, а **module** — имя файла, т.е. *root/dir/module.src*.
