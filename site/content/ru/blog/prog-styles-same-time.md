...
Для поверки данного предположения, я решил добавить в свой [новый язык программирования](/ru/blog/2021/05/24/необычная-концепция-синтаксиса-языка-программирования/)
...
### З.З.Ы
В [комментариях @gbg](https://habr.com/ru/company/timeweb/blog/569422/comments/#comment_23301086) привел очень простой ответ на один из поднятых вопросов. 
...
[Ссылка на первую публикаци](https://habr.com/ru/companies/timeweb/articles/569422/)
