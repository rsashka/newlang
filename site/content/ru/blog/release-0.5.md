...
- В синтаксис языка доабвлена поддержка новых типов данных (лямбды, наборы)
- Реализована концепция безопасного управления памятью с проверкой во время компиляции
- Примеры кода многопоточных программ
- Перегрузка нативных функций и их экспорт в С\С++

- Изменяемые (виртуальные) функции
