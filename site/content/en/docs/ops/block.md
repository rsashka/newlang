...
Можно указать сразу несколько типов, перечислив их в угловых скобрах через знак **+** и *без завершающей запятой*.
...
Нативный синтаксис, это блок кода с исходным текстом программы на языке реализации (С++). 
Он начинается и заканчивается на фигурные скобки со знаком процента («**{%**» и «**%}**»).

Внутри блока кода с нативный синтаксисом можно применять произвольные элементы языка реализации (С++), 
...
С помощью блока кода с нативным синтаксисом можно реализовать разные элементы, которые отсуствуют в языке NewLang, 
...
путем обращения к локальным объектам или макросам программы изнутри нативного блока кода.
