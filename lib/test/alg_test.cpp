...
TEST(Alg, Follow) {
    ...
    ASSERT_NO_THROW(result = jit->Run("[1]-->100"));
    ASSERT_TRUE(result);
    ASSERT_EQ(100, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("[-1]-->99"));
    ASSERT_TRUE(result);
    ASSERT_EQ(99, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("[0]-->111"));
    ASSERT_TRUE(result);
    ASSERT_TRUE(result->is_none_type());

    ASSERT_NO_THROW(result = jit->Run("[1]-->111"));
    ASSERT_TRUE(result);
    ASSERT_EQ(111, result->GetValueAsInteger());



    ASSERT_NO_THROW(result = jit->Run("[0]-->100,[1]-->300"));
    ASSERT_TRUE(result);
    ASSERT_EQ(300, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("[0]-->100,[0]-->300,[99]-->99,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(99, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("[0]-->111,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(1000, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("[0]-->{100},[1]-->{10;20;30}"));
    ASSERT_TRUE(result);
    ...
    ASSERT_NO_THROW(result = jit->Run("[0]-->111,[...]-->{30;50;1000}"));
    ASSERT_TRUE(result);
    ASSERT_EQ(1000, result->GetValueAsInteger());


    ASSERT_NO_THROW(result = jit->Run("cond := 100; [cond]-->111,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(111, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("cond2 := 0; [cond2]-->111,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(1000, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("val := 1\\1; [val == 1]-->111,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(111, result->GetValueAsInteger());

    ASSERT_NO_THROW(result = jit->Run("val := 1\\1; [val < 0]-->111,[...]-->1000"));
    ASSERT_TRUE(result);
    ASSERT_EQ(1000, result->GetValueAsInteger());
...
TEST(Alg, Repeat) {
    ...
    ASSERT_NO_THROW(result = jit->Run("result := 0"));
    ASSERT_TRUE(result);
    ASSERT_EQ(0, result->GetValueAsInteger());

    ObjPtr cond;
    ASSERT_NO_THROW(cond = jit->Run("result < 4"));
    ASSERT_TRUE(cond);
    ASSERT_TRUE(cond->GetValueAsBoolean());

    ASSERT_NO_THROW(result = jit->Run("result += 1"));
    ASSERT_TRUE(result);
    ...
    ASSERT_NO_THROW(result = jit->Run("result += 3"));
    ASSERT_TRUE(result);
    ...
    ObjPtr counter;
    ASSERT_NO_THROW(counter = jit->Run("counter := 0"));
    ...
    ASSERT_NO_THROW(counter = jit->Run("[result -= 1] <-> {counter += 1}"));
    ASSERT_TRUE(counter);
    ASSERT_EQ(0, counter->GetValueAsInteger());
    ...
    ASSERT_NO_THROW(counter = jit->Run("{result += 1; counter += 1} <-> [result < 10]"));
    ...
    ASSERT_NO_THROW(counter = jit->Run("result"));
...
TEST(Alg, Foreach) {
    ...
    ASSERT_NO_THROW(temp = jit->Run("counter += 1"));
    ASSERT_TRUE(temp);
    ASSERT_EQ(2, temp->GetValueAsInteger());

    ASSERT_NO_THROW(temp = jit->Run("counter += counter"));
    ASSERT_TRUE(temp);
    ...
    ASSERT_NO_THROW(temp = jit->Run(":Bool[_](dict)"));
    ASSERT_TRUE(temp);
    ASSERT_TRUE(temp->is_bool_type());
    ASSERT_FALSE(temp->is_scalar());
    ASSERT_TRUE(temp->GetValueAsBoolean());
    ...
    ASSERT_NO_THROW(temp = jit->Run(":Bool[0](dict)"));
    ASSERT_TRUE(temp);
    ASSERT_TRUE(temp->is_bool_type());
    ...
    ASSERT_NO_THROW(temp = jit->Run("@not(dict)"));
    ASSERT_TRUE(temp);
    ASSERT_TRUE(temp->is_bool_type());
    ...
    ObjPtr summa;
    ASSERT_NO_THROW(summa = jit->Run("summa := 0"));
    ASSERT_STREQ("0", summa->toString().c_str());
    ASSERT_NO_THROW(summa = jit->Run("summa += 100"));
    ASSERT_STREQ("100", summa->toString().c_str());

    ASSERT_NO_THROW(temp = jit->Run(":Bool[...]( (1,) )"));
    ...
    ASSERT_NO_THROW(temp = jit->Run(":Bool[...]( (0,) )"));
    ASSERT_STREQ("[0,]:Bool", temp->toString().c_str());
    ASSERT_NO_THROW(temp = jit->Run(":Bool( (0,) )"));
    ASSERT_STREQ("1", temp->toString().c_str());

    ASSERT_ANY_THROW(temp = jit->Run(":Bool[...]( (,) )"));
    ASSERT_ANY_THROW(temp = jit->Run(":Bool[_]( (,) )"));
    ASSERT_NO_THROW(temp = jit->Run(":Bool( (,) )"));
    ASSERT_STREQ("0", temp->toString().c_str());


    ASSERT_NO_THROW(temp = jit->Run("counter = 0; [dict] <-> {counter, dict := ... dict; summa += counter}"));

    ASSERT_NO_THROW(summa = jit->Run("summa"));
    ASSERT_STREQ("250", summa->toString().c_str());

    ASSERT_NO_THROW(temp = jit->Run("counter"));
    ASSERT_TRUE(temp);
    ...
    ASSERT_NO_THROW(summa = jit->Run("sum := 0"));
    ASSERT_TRUE(summa);
    ASSERT_STREQ("0", summa->toString().c_str());
    ASSERT_NO_THROW(summa = jit->Run("sum += 1"));
    ASSERT_TRUE(summa);
    ASSERT_STREQ("1", summa->toString().c_str());
    ASSERT_NO_THROW(summa = jit->Run("sum += 2"));
    ASSERT_TRUE(summa);
    ...
    ASSERT_NO_THROW(temp = jit->Run("val::=1; item := 0; [dict] <-> {item, dict := ... dict; print('Sum: %s, Item: %s\\n', :StrChar(sum), :StrChar(item)); sum += item}"));
    ASSERT_TRUE(temp);
    ASSERT_STREQ("(,)", temp->GetValueAsString().c_str());

    ASSERT_NO_THROW(summa = jit->Run("item"));
    ASSERT_EQ(4, summa->GetValueAsInteger());

    ASSERT_NO_THROW(summa = jit->Run("sum"));
    ...
    ASSERT_NO_THROW(counter = jit->Run("counter := 55"));
    ASSERT_EQ(55, counter->GetValueAsInteger());

    ObjPtr tensor;
    ASSERT_NO_THROW(tensor = jit->Run("tensor := [10,11,12,]"));
    ASSERT_TRUE(tensor);
    ...
    ASSERT_NO_THROW(temp = jit->Run("counter, tensor  := ... tensor "));
    ASSERT_TRUE(temp);
    ...
    ASSERT_ANY_THROW(temp = jit->Run("counter, tensor := ... tensor"));
    //    ASSERT_TRUE(temp);
    //    ASSERT_TRUE(temp->is_tensor_type());
    ...
    ASSERT_NO_THROW(jit->Run("item2 := 0"));
    ASSERT_NO_THROW(summa2 = jit->Run("summa := 0"));
    ASSERT_NO_THROW(tensor2 = jit->Run("tensor := [10,20,30,40,50,60,]"));
    ASSERT_NO_THROW(temp2 = jit->Run("[tensor] <-> {item2, tensor := ... tensor; summa += item2}"));
    ASSERT_TRUE(temp2);
    ASSERT_TRUE(temp2->is_none_type());

    ASSERT_NO_THROW(summa2 = jit->Run("summa"));
    ASSERT_EQ(210, summa2->GetValueAsInteger());

    ASSERT_NO_THROW(temp2 = jit->Run("item2"));
    ASSERT_EQ(60, temp2->GetValueAsInteger());

    ASSERT_NO_THROW(tensor2 = jit->Run("tensor"));
    ASSERT_TRUE(tensor2->is_none_type());
    ASSERT_FALSE(tensor2->GetValueAsBoolean());

    ObjPtr tensor_size;
    ASSERT_NO_THROW(tensor_size = jit->Run("tensor_size := [10,20,30,40,]"));
...
TEST(Alg, DISABLED_BreakContinue) {
    ...
    ObjPtr count;
    ObjPtr result;
    ASSERT_NO_THROW(result = jit->Run(run_raw));
    ASSERT_NO_THROW(count = jit->Run("count"));
    ASSERT_TRUE(result);
    ...
    ASSERT_NO_THROW(result = jit->Run(run_macro));
    ASSERT_NO_THROW(count = jit->Run("count"));
    ASSERT_TRUE(result);
    ASSERT_TRUE(result->is_integer());
    ASSERT_EQ(6, count->GetValueAsInteger());
...
TEST(Alg, Else) {
    ...
    ASSERT_NO_THROW(result = jit->Run("42"));
    ASSERT_TRUE(result);
    ...
    ASSERT_NO_THROW(result = jit->Run("[0]<->{ 43 },[...]-->{44}"));
    ASSERT_TRUE(result);
    ASSERT_TRUE(result->is_integer()) << result->toString().c_str() << " (" << toString(result->getType()) << ")";
    ASSERT_EQ(44, result->GetValueAsInteger()) << result->toString().c_str();

    ASSERT_NO_THROW(result = jit->Run("{- --100-- -}"));
    ASSERT_TRUE(result);
    ...
    //
    //    ASSERT_NO_THROW(result = jit->Run("[0] --> 1, [1] --> 2, [...] -->3"));
    //    ASSERT_TRUE(result);
    //    ASSERT_TRUE(result->is_integral()) << result->toString().c_str() << " (" << toString(result->getType()) << ")";
    //    ASSERT_EQ(2, result->GetValueAsInteger()) << result->toString().c_str();
    //
    //    ASSERT_NO_THROW(result = jit->Run("[0] --> 1, [0] --> 2, [...] -->3"));
    //    ASSERT_TRUE(result);
    //    ASSERT_TRUE(result->is_integral()) << result->toString().c_str() << " (" << toString(result->getType()) << ")";
...
TEST(Alg, Return) {
    ...
    try {
        ASSERT_ANY_THROW(result = jit->Run("--"));
    ...
    try {
        ASSERT_ANY_THROW(result = jit->Run("--100--"));
    } catch (IntMinus &except) {
        ASSERT_TRUE(except);
        ASSERT_EQ(ObjType::RetMinus, except.getType()) << newlang::toString(except.getType());
        ASSERT_TRUE(except.m_return_obj);
    ...
    try {
        ASSERT_ANY_THROW(result = jit->Run("{ ++100++; 200 }"));
    } catch (IntPlus &except) {
        ASSERT_TRUE(except);
        ASSERT_EQ(ObjType::RetMinus, except.getType()) << newlang::toString(except.getType());
        ASSERT_TRUE(except.m_return_obj);
    ...
    try {
        ASSERT_NO_THROW(result = jit->Run("ns { ns ++100++; 200}"));
        ASSERT_TRUE(result);
        ASSERT_STREQ("100", result->toString().c_str());
    } catch (IntAny &except) {
        ASSERT_TRUE(0);
    ...
    try {
        ASSERT_NO_THROW(result = jit->Run("br:= 5; ns { br+=1; [br>10]--> ns:: ++ br ++; ns:: --br--; 200 }"));
        ASSERT_TRUE(result);
    ...
    //
    //    try {
    //        ASSERT_NO_THROW(result = jit->Run("--'Тест'--"));
    //    } catch (Return &except) {
    //        ASSERT_TRUE(except);
    ...
    //
    //    try {
    //        ASSERT_NO_THROW(result = jit->Run("--:Int32--"));
    //    } catch (Return &except) {
    //        ASSERT_TRUE(except);
    //        ASSERT_EQ(ObjType::RetMinus, except.getType());
    //        ASSERT_TRUE(except.m_return_obj);
    ...
    //
    //    try {
    //        ASSERT_NO_THROW(result = jit->Run("--:Error()--"));
    //    } catch (Return &except) {
    //        ASSERT_TRUE(except);
    //        ASSERT_EQ(ObjType::RetMinus, except.getType());
    //        ASSERT_TRUE(except.m_return_obj);
    ...
    //
    //    try {
    //        ASSERT_NO_THROW(result = jit->Run("--:Error('ТЕКСТ')--"));
    //    } catch (Return &except) {
    //        ASSERT_TRUE(except);
    //        ASSERT_EQ(ObjType::RetMinus, except.getType());
    //        ASSERT_TRUE(except.m_return_obj);
    ...
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{count := 1; count += 1; count += 1; count += 1; count += 1;};")););
    //    ASSERT_TRUE(result);
    //    ASSERT_TRUE(result->is_integer()) << toString(result->getType());
    //    ASSERT_EQ(5, result->GetValueAsInteger());
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{count := 1; count += 1; count += 1; count += 1; count += 1;}; 99")););
    //    ASSERT_TRUE(result);
    //    ASSERT_TRUE(result->is_integer()) << result->toString().c_str();
    //    ASSERT_EQ(99, result->GetValueAsInteger());
    //
    //    result.reset();
    //    ASSERT_ANY_THROW(ASSERT_NO_THROW(result = jit->Run("{count := 1; count += 1; count += 1; --55--; count += 1; count += 1;}; 5555")););
    //    ASSERT_FALSE(result);
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{- count := 1; count += 1; count += 1; --77--; count += 1; count += 1; -}", nullptr, Context::CatchType::CATCH_ALL););
    //            ASSERT_TRUE(result);
    //            ASSERT_TRUE(result->is_integer()) << result->toString().c_str();
    //            ASSERT_EQ(77, result->GetValueAsInteger());
    //
    //            result.reset();
    //            ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{-count := 1; count += 1; count += 1; --77--; count += 1; count += 1;-}; 7777")););
    //            ASSERT_TRUE(result);
    //            ASSERT_TRUE(result->is_integer()) << result->toString().c_str();
    //            ASSERT_EQ(7777, result->GetValueAsInteger());
    //
    //            result.reset();
    //            ASSERT_ANY_THROW(ASSERT_NO_THROW(result = jit->Run("{ {count := 1; count += 1; count += 1; --:Error(88)--; count += 1; count += 1};  8888; }")););
    //            ASSERT_FALSE(result);
    //
    //            result.reset();
    //            ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {+count := 1; count += 1; count += 1; ++:Error(99)++; count += 1; count += 1+}; 888}")););
    //            ASSERT_TRUE(result);
    //            ASSERT_TRUE(result->is_integer()) << result->toString().c_str();
    //            ASSERT_EQ(888, result->GetValueAsInteger());
    //
    //            result.reset();
    //            ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {+count := 1; count += 1; count += 1; ++:Error(99)++; count += 1; count += 1+}; }")););
    //            ASSERT_TRUE(result);
    //            ASSERT_EQ(1, result->size()) << result->toString().c_str();
    //            ASSERT_EQ(99, (*result)[0].second->GetValueAsInteger()) << result->toString().c_str();
    //
    //            result.reset();
    //            ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {-count := 1; count += 1; count += 1; --:Error(33)--; count += 1; count += 1-};  }")););
    //            ASSERT_TRUE(result);
    //            ASSERT_EQ(1, result->size()) << result->toString().c_str();
    //            ASSERT_EQ(33, (*result)[0].second->GetValueAsInteger()) << result->toString().c_str();
    //
    //            result.reset();
    //            ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {*count := 1; count += 1; count += 1; --:Error(44)--; count += 1; count += 1*};  9999; }")););
    //            ASSERT_TRUE(result);
    //            ASSERT_EQ(9999, result->GetValueAsInteger()) << result->toString().c_str();
    //
    //            result.reset();
    //            // Не должен перехватытвать другой класс объекта
    //            ASSERT_ANY_THROW(ASSERT_NO_THROW(result = jit->Run("{ {*count := 1; count += 1; count += 1; --:Error(55)--; count += 1; count += 1*}:ErrorRunTime;  }")););
    //            ASSERT_FALSE(result);
    //
    //
    ...
    //    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{* {*count := 1; count += 1; count += 1; --:Error(66)--; count += 1; count += 1*}:ErrorRunTime;  777; *}")););
    //    //    ASSERT_TRUE(result);
    ...
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {*count := 1; count += 1; count += 1; --:ErrorRunTime(77)--; count += 1; count += 1*}:ErrorRunTime }")););
    //    ASSERT_TRUE(result);
    //    ASSERT_EQ(1, result->size());
    //    ASSERT_EQ(77, (*result)[0].second->GetValueAsInteger());
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{ {*count := 1; count += 1; count += 1; --:ErrorRunTime(88)--; count += 1; count += 1*}:ErrorRunTime;  9999; }")););
    //    ASSERT_TRUE(result);
    //    ASSERT_EQ(9999, result->GetValueAsInteger());
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{{*count := 1; count += 1; count += 1; --:ErrorRunTime(77)--; count += 1; count += 1*}:Error }")););
    //    ASSERT_TRUE(result);
    //    ASSERT_EQ(1, result->size());
    //    ASSERT_EQ(77, (*result)[0].second->GetValueAsInteger());
    //
    //    result.reset();
    //    ASSERT_NO_THROW(ASSERT_NO_THROW(result = jit->Run("{{*count := 1; count += 1; count += 1; --:ErrorRunTime(88)--; count += 1; count += 1*}:Error;  9999; }")););
    //    ASSERT_TRUE(result);
    //    ASSERT_EQ(9999, result->GetValueAsInteger());
}
