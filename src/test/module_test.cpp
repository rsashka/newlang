...
TEST(Module, Load) {
    ...
    ASSERT_FALSE(ctx.FindTerm("module_var1"));
    ASSERT_FALSE(ctx.FindTerm("ns::module_var2"));
    ASSERT_FALSE(ctx.FindTerm("ns::ns2::module_var3"));
    ASSERT_FALSE(ctx.FindTerm("ns3::ns4::module_var4"));
