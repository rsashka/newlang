...
//
    ...
    public:
        ...
        //        static ObjPtr Call(Runner *runner, Obj & obj, Obj *args);
        static ObjPtr EvalTerm(TermPtr term, Context *runner);
    ...
    protected:
         ...
         * @return 
         */
        static inline void CheckObjTerm_(TermPtr & term, Context * runner) {
            if (!term->m_obj) {
                term->m_obj = EvalTerm(term, runner);
            }
        }
        ...
        static TermPtr EvalStack(Context & run);
