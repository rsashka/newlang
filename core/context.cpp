...
//            return (*reinterpret_cast<FunctionType *> (func->m_func_ptr))(this,
//                    *arg_in); // Непосредственно вызов функции
//        } else if(func->m_var_type_current == ObjType::TRANSPARENT) {
//            ASSERT(func->m_func_ptr);
//            return (*reinterpret_cast<TransparentType *> (func->m_func_ptr))(this,
//                    *arg_in); // Непосредственно вызов функции
//        } else if(func->m_var_type_current == ObjType::NativeFunc) {
//            return func->CallNative(this, *arg_in);
//        } else if(func->m_var_type_current == ObjType::EVAL_FUNCTION ||
//                func->m_var_type_current == ObjType::EVAL_TRANSP) {
//            return Context::EvalBlock(this, func->m_block_source, *arg_in);
//        } else if(func->m_var_type_current == ObjType::EVAL_AND) {
//            return Context::EvalBlockAND(this, func->m_block_source, *arg_in);
//        } else if(func->m_var_type_current == ObjType::EVAL_OR) {
//            return Context::EvalBlockOR(this, func->m_block_source, *arg_in);
//        } else if(func->m_var_type_current == ObjType::EVAL_XOR) {
//
//            return Context::EvalBlockXOR(this, func->m_block_source, *arg_in);
//        }
...
ObjPtr Context::CreateRVal(Context *ctx, TermPtr term, Object *local_vars) {
    ...
    switch(term->getTermID()) {
        ...
        case TermID::TYPE_CALL:
            ...
            result->m_var_type_fixed = typeFromString(term->GetFullName(), ctx, nullptr);
